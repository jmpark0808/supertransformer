...
class Backbone(nn.Module):
    def __init__(self, in_chans, P1=1, P2=1, P3=3, P4=5, reduction=4, pretrained=None):
        super(Backbone, self).__init__()
        self.level1_0 = DownsamplerBlockConv(in_chans, 16)
...
class FastSal(nn.Module):
    ...
    def __init__(self, in_chans, P1=1, P2=1, P3=3, P4=5, reduction=4, pretrained=None):
        ...
        self.backbone = Backbone(in_chans, P1, P2, P3, P4, reduction, pretrained)
