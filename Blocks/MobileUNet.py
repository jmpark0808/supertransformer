...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1., in_channels=3):
        ...
        self.features = [conv_bn(in_channels, input_channel, 1)]
...
class MobileNetV2Tube(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        super(MobileNetV2Tube, self).__init__()
        block = InvertedResidual
        input_channel = 32
        last_channel = 320
        interverted_residual_setting = [
        ...
        for t, c, n, s in interverted_residual_setting:
            ...
            for i in range(n):
                ...
                input_channel = output_channel
        # building last several layers
        self.features.append(nn.Conv2d(input_channel, 1, 1, 1))
        # self.features.append(conv_1x1_bn(input_channel, 1))
        # make it nn.Sequential
        self.features = nn.Sequential(*self.features)
...
if __name__ == "__main__":
    ...
    model = MobileNetV2_unet(input_size=32, pre_trained=None)
