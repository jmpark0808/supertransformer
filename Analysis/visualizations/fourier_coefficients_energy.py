...
plt.ylabel('Normalized Cumulative Energy', fontsize=20)
plt.axvline(10, 0, 1, linestyle='--', c='red')

plt.savefig('/mnt/d/Figures/SuperFormer/fourier_coefficients_energy.pdf', format='pdf')
plt.show()
