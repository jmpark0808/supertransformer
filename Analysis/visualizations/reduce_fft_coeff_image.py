...
for file in tqdm(os.listdir(dataset_images)[:num_images]):
    ...
    for label in range(784):
        if np.sum(segments == label) > 0:
            ...
            xi, yi, og_xi, og_yi= fourier_descriptors(regions, 1, label)
            ax[0, 0].plot(xi, -yi, c = 'blue')
            xi, yi, og_xi, og_yi= fourier_descriptors(regions, 2, label)
            ax[0, 1].plot(xi, -yi, c = 'blue')
            xi, yi, og_xi, og_yi= fourier_descriptors(regions, 5, label)
            ax[1, 0].plot(xi, -yi, c = 'blue')
            ...
            ax[1, 1].plot(og_xi, -og_yi, c = 'blue')
            ax[1, 1].set_title('All Coefficients', fontsize=20)
            ax[0, 0].set_title('2 Coefficients', fontsize=20)
            ax[0, 1].set_title('4 Coefficients', fontsize=20)
            ax[1, 0].set_title('10 Coefficients', fontsize=20)
    ...
    ax[1, 0].set_ylim(-150, -300)
    ax[1, 0].set_xlim(150, 300)
    ax[1, 1].set_ylim(-150, -300)
