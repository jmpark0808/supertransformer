...
ax[0, 0].legend()
ax[0, 0].set_title('Original', fontsize=title_fontsize)
ax[0, 0].set_ylabel('Images', fontsize=ylabel_fontsize)
...
ax[1, 0].set_ylabel('Amplitude', fontsize=ylabel_fontsize)
...
ax[0, 1].legend()
ax[0, 1].set_title('Translated', fontsize=title_fontsize)
...
ax[0, 3].legend()
ax[0, 3].set_title('Rotated', fontsize=title_fontsize)
