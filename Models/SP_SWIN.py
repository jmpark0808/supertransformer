...
class SP_SWINU(nn.Module):
    ...
    '''
    def __init__(self, nfeat, nhid, nheads, ntfm, dropout, dropout_edge, resolution):
        ...
        'depths': [ntfm, ntfm, ntfm*3, ntfm], #(tuple(int)): Depth of each Swin Transformer layer.
        'num_heads': [nheads, nheads*2, nheads*4, nheads*8], #(tuple(int)): Number of attention heads in different layers.
