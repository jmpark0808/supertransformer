...
import torch
from Models.SP_SWIN import SP_SWIN_ImageNet
...
class SP_ImageNet_SWIN_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SP_SWIN_ImageNet(input_dim, self.tfm_hp[1], self.tfm_hp[0], self.tfm_hp[2], self.dropout, self.dropout_edge)
        if self.load:
