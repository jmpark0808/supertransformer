...
import torch
from Models.SP_TFM import SP_Cross_TFM
...
class SP_CTFM_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SP_Cross_TFM(6, input_dim-6, self.dilation, self.tfm_hp[1], self.tfm_hp[0], self.tfm_hp[2], self.dropout)
        self.iteration = 0
