...
from Blocks.MobileVitU import MobileVITV3_unet
...
class Image_MBVITU_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = MobileVITV3_unet(input_size=(self.size, self.size), pre_trained=None)
