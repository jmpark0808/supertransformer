...
class SP_ImageNet_SWIN_RECON_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SwinUTransformer(img_size=self.res, resolution_size=self.size, in_chans=input_dim, patch_size=1, window_size=self.window_size,
    ...
    def loss(self, pred, label):
        ...
        """
        label = label.reshape(label.size(0), label.size(1), -1).permute(0, 2, 1)
