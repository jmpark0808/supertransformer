...
import torch
from Models.SP_GAT import SP_GATv3
...
class SP_GATv3_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SP_GATv3(input_dim, self.tfm_hp[1], self.dropout, self.tfm_hp[0], self.tfm_hp[2])
        self.iteration = 0
