...
import torch
from Models.SP_GAT_PyG import SP_GAT_DIN
...
class SP_ImageNet_DGAT_PyG_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SP_GAT_DIN(input_dim, self.tfm_hp[1], self.dropout, self.tfm_hp[0], self.tfm_hp[2], self.num_seg)
        if self.load:
