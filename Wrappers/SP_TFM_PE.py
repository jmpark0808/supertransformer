...
import torch
from Models.SP_TFM import SP_TFM_AP, SP_TFM_PE
...
class SP_TFM_PE_Wrapper(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.supert = SP_TFM_PE(2+BINS*3+2*NUM_CHUNK, 16, 3, 0., 8, 6, self.num_seg, norm='bn')
        self.iteration = 0
