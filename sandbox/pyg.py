...
import os
train_dir = '/mnt/pegasus/Datasets/DUTS/DUTS-TR/'
...
data_list = SPDataset(image_list, mask_list, 400, 224, 10,  'SPGFFT', True,10, False, False )
# data_list = SPDataset()
loader = DataLoader(data_list, batch_size=128, shuffle=False, num_workers=8)
